...
const ChatWidget: React.FC<ChatWidgetProps> = ({
    ...
    useEffect(() => {
        const initSocket = () => {
            ...
            newSocket.on('new-message', (msg: ChatMessage & { sessionId?: string; messageId?: string }) => {
            ...
            try {
                ...
                if (data.sessionId) {
                    ...
                    if (data.messages && data.messages.length > 0) {
                        const messages = data.messages.map((m: ChatMessage & { timestamp: string | Date; messageId?: string }) => ({
                            role: m.role,
                            text: m.text,
